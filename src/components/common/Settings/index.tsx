...
const Settings = () => {
    ...
    return <Popover>
        ...
        <PopoverContent align={'end'} className="flex flex-col gap-4 p-6 w-fit bg-[#151419] rounded-3xl border border-[#FBFBFB] text-white">
            <div className="text-md font-bold">Transaction Settings</div>
            {/* <Separator orientation={'horizontal'} className="bg-border" /> */}
            <Separator orientation={'horizontal'} className="bg-[#FBFBFB]" />
            <SlippageTolerance />
            <TransactionDeadline />
            <Multihop />
            <ExpertMode />
        ...
        <div className="flex gap-2">
            ...
            <div className="flex">
                <Input
                    ...
                    className={`text-right border-none text-md font-semibold bg-[#323236] rounded-l-xl rounded-r-none w-[70px]`}
                    placeholder={'0.0'}
                />
                {/* <div className="bg-card-dark text-sm p-2 pt-2.5 rounded-r-xl select-none">%</div> */}
                <div className="bg-[#323236] text-sm p-2 pt-2.5 rounded-r-xl select-none">%</div>
            </div>
        </div>
    ...
    return <div className="flex flex-col gap-2">
        ...
        <div className="flex">
            <Input
                ...
                className={`text-left border-none text-md font-semibold bg-[#323236] rounded-l-xl rounded-r-none w-full`}
            />
            {/* <div className="bg-card-dark text-sm p-2 pt-2.5 rounded-r-xl select-none">minutes</div> */}
            <div className="bg-[#323236] text-sm p-2 pt-2.5 rounded-r-xl select-none">minutes</div>
        </div>
    </div>
