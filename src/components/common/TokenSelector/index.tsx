...
const Search = ({
  ...
  return (
    <input
      ...
      className="w-full text-white px-4 py-3 bg-[#151419] rounded-xl border border-[#FBFBFB]"
...
//   <div className="w-full mb-4 h-[60px] text-left bg-card rounded-2xl animate-pulse"></div>
    <div className="w-full mb-4 h-[60px] text-left bg-[#151419] rounded-2xl animate-pulse"></div>
);
