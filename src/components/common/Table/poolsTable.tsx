    ...
    return (
        <>
                ...
                <div className="flex gap-4 w-full justify-between items-center p-4 pb-0">
                    <div className="flex items-center relative w-fit">
                        <Input
                            ...
                            className="border border-[#FBFBFB] pl-12 h-12 max-w-80 md:w-64 lg:w-80 focus:border-opacity-100 rounded-xl"
                        />
                        {/* <Search className="absolute left-4 text-border" size={20} /> */}
                        <Search className="absolute left-4 text-[#FBFBFB]" size={20} />
                    </div>
                    {/* <ul className="flex gap-1 p-1 border rounded-xl border-border/60 w-fit h-12 max-xs:hidden"> */}
                    <ul className="flex gap-1 p-1 border rounded-xl border-[#FBFBFB] w-fit h-12 max-xs:hidden">
                        <li>
                            <Button
            ...
            <Table>
                ...
                <TableHeader className="border-b border-t border-[#FBFBFB]">
                    {table.getHeaderGroups().map((headerGroup) => (
                        <TableRow key={headerGroup.id} className="hover:bg-transparent border-[#FBFBFB]">
                        ...
                        table.getRowModel().rows.map((row: any) => {
                            return (
                                <TableRow
                                    ...
                                    // className="border-card-border/40 bg-card-dark hover:bg-[#201F24] cursor-pointer"
                                    className="border-card-border/40 bg-[#151419] hover:bg-[#201F24] cursor-pointer"
                                    onClick={() => {
                                        if (action) {
