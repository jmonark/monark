...
export const ETERNAL_FARMINGS_API =
    'https://api.algebra.finance/api/APR/eternalFarmings/?network=rootstock';

export const POOL_MAX_APR_API =
    'https://api.algebra.finance/api/APR/pools/max?network=rootstock';

export const POOL_AVG_APR_API =
    'https://api.algebra.finance/api/APR/pools/?network=rootstock';
